...
5. Дайте доступ в `System Settings → Privacy → Accessibility`.
...
| Комбинация клавиш | Действие | Эффект |
|-------------------|----------|--------|
| <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>V</kbd> | Старт автоматической печати | 🟢 Запускает процесс ввода текста |
| <kbd>ESC</kbd> | Экстренная остановка | 🔴 Немедленно прерывает печать |
| <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>Alt</kbd>+<kbd>+</kbd> | Стандартная скорость | ⏱ Сброс скорости к среднему значению |
| <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>Alt</kbd>+<kbd>></kbd> | Увеличить скорость | ⏩ Ускорение на 15% |
| <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>Alt</kbd>+<kbd><</kbd> | Уменьшить скорость | ⏪ Замедление на 15% |
| <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>P</kbd> | Пауза/продолжить | ⏸️ Временная остановка процесса |
